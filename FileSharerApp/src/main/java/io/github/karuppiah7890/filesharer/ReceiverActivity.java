...
public class ReceiverActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case FileReceiver.FILE_RECEIVED :
                    ...
                    file.renameTo(new File(Environment.getExternalStorageDirectory() + "/Patient Data/FileSharer/Session " + (editSessionIndex + 1) + " - " +file.getName()));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editSessionIndex = fromEdit.getInt("editSessionIndex");
    }
}
