...
public class ReceiverThread extends Thread {
    ...
    public ReceiverThread(int port,Messenger messenger){
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/Patient Data/FileSharer/");
    ...
    public void run() {
        ...
        try {
            ...
            File receiveFile = new File(Environment.getExternalStorageDirectory() + "/Patient Data/FileSharer/" + fileName);
